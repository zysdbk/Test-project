...
public class CustomerController {
	 ...
	 * 根据id 查询书籍对象并分页
	 */
	@RequestMapping("/BookfindById")
	@ResponseBody
	public Map<String,Object> BookfindById(Integer customerid,Integer page,Integer rows){
		//设置分页参数
		...
		//查询所有数据
		List<Book> book = customerService.findBook(customerid);
